# Generated by Django 4.1.5 on 2023-01-12 11:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'К выполнению'), (2, 'В прогрессе'), (3, 'Выполнено'), (4, 'Архив')], default=1, verbose_name='Статус')),
